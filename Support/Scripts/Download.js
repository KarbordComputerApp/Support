var ViewModel = function () {
    ...
    downloadVideoUri = server + '/api/Data/DownloadVideo/';
    tokenUri = server + '/api/Data/Token/';

    var a = document.createElement("a");

    $("#Karbord-AFI2").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-AFI2";
        a.click();
    });

    $("#Karbord-AFI3").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-AFI3";
        a.click();
    });

    $("#Karbord-ACC6").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-ACC6";
        a.click();
    });

    $("#Karbord-CSH5").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-CSH5";
        a.click();
    });

    $("#Karbord-FCT6").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-FCT6";
        a.click();
    });

    $("#Karbord-INV6").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-INV6";
        a.click();
    });

    $("#Karbord-PAY6").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-PAY6";
        a.click();
    });

    $("#Karbord-ERJ1").click(function () {
        a.href = downloadVideoUri + idUser + "/Karbord-ERJ1";
        a.click();
    });
};
